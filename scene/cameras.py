...
class Camera(nn.Module):
    def __init__(self, colmap_id, pose_id, R, T, K, FoVx, FoVy, image, gt_alpha_mask,
                 ...
                 trans=np.array([0.0, 0.0, 0.0]), scale=1.0, data_device = "cuda", pair_t = [], jump_note = [], dataset_type = None
                 ):
        ...
        self.pair_t = torch.tensor(pair_t).to(self.data_device)
        self.jump_note = torch.tensor(jump_note).to(self.data_device)
